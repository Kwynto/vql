...
***Аргументы:*** имя базы данных  
***Возвращаемое значение:*** код ошибки  
***Описание:*** Удаление базы дынных с заданным именем.  
***Пример:***  
```vql
    $err = drop-db("dbName")
```
...
***Возвращаемое значение:***  код ошибки  
***Описание:*** Принимает три массива строк с названиями баз данных, именами пользователей и названиями привилегий. Затем устанавливает указанные привилегии для пользователей в каждой базе данных. Возвращает признак успешности и код ошибки.  
***Пример:***  
```vql
...
***Аргументы:*** список БД, список пользователей, список привилегий  
***Возвращаемое значение:***  код ошибки  
***Описание:*** Принимает три массива строк с названиями баз данных, именами пользователей и названиями привилегий. Затем удаляет указанные привилегии для пользователей в каждой базе данных. Возвращает признак успешности и код ошибки.  
***Пример:***  
```vql
